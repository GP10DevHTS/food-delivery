...
<html>
<head>
    <title>Customer Signup | Foodie Deliver Mbarara</title>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn">
                                        <button class="btn btn-primary" type="button"><i class="fas fa-phone"></i></button>
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn">
                                        <button class="btn btn-primary" type="button"><i class="fas fa-home"></i></button>
                                    </span>
                                </div>
                            </div>
                        </div>
